...
SocketClientPort::SocketClientPort(int portNo, char * serverip, int hostport) : BasePort(portNo, false, NUM_BANDS) {
...
SocketServerPort::SocketServerPort(int portNo, int hostport) : BasePort(portNo, false, NUM_BANDS) {
    int server_fd;
